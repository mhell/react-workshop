...
const Form = ({ assignees, onSubmit, editTodo }) => {
  ...
  return (
    <form
      id="todoForm"
      className="rounded border shadow-sm m-4 p-3"
    ...
    >
      <div className="mb-3">
        ...
        <input
          ...
          {...register("title", {
            ...
            maxLength: {
              value: 100,
              message: "Title needs to be less than 100 characters",
            },
          })}
        />
      ...
      <div className="mb-3">
        ...
        <textarea
          ...
          {...register("description", {
            ...
            maxLength: {
              value: 100,
              message: "Description needs to be less than 500 characters",
            },
          })}
        ></textarea>
      ...
      <div className="row">
        ...
        <div className="col-sm mb-3">
          <label htmlFor="assignIput" className="form-label">
      ...
      <div className="mb-3">
        <label htmlFor="attachmentInput" className="form-label">
          Attachments
        </label>
        <div className="input-group">
          ...
          />
          <button
            className="btn btn-outline-secondary clearAttachments"
            type="button"
      ...
      <div className="border rounded p-3 mb-3" style={{ minHeight: "60px" }}>
        <ul className="list-group attachmentList">
          {attachments.map((attachment, index) => (
            <li
              key={index}
              className="list-group-item border-0 bi bi-file-earmark"
            >
